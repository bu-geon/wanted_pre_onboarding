      ...
      <form>
        <section className={styles['user-input']}>
          ...
          <EmailVaildation
            ...
            width='1em'
            fill={emailState.isValid ? '#50acad' : 'grey'}
          />
          {!emailState.isValid && inputCount > 0 && (
            <div className={styles['email-vaildation']}>
        ...
        <section className={styles['user-input']}>
          ...
          {isPWVisible && (
            <Visible
              className={styles.svg}
              onClick={pwVisibleClickHandler}
              fill='#50acad'
            />
          )}
          {!isPWVisible && (
            <Invisible className={styles.svg} onClick={pwVisibleClickHandler} />
          )}
        </section>
      </form>
    </Card>
